import logging
import json
from backend.services.adk.adk_orchestrator import run_adk_orchestration_stream, run_adk_edit_orchestration_stream
...
logger = logging.getLogger("backend.services.adk.router_agent")

class RouterAgent:
    """
    Dynamic Router Agent classifying user prompts and request context
    to route execution flows to appropriate multi-agent pipelines.
    """
    def __init__(self):
        pass
    ...
    async def route_request(self, request_data: dict):
        ...
        and calls the matching orchestrator flow, injecting routing stats.
        """
