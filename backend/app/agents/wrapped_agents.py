...
from backend.app.agents.agent_registry import register_adk_agent

logger = logging.getLogger("backend.app.agents.wrapped_agents")
...
class MemoryADKAgent(BaseADKAgent):
    ...
    async def _execute(self, input_data: dict, **kwargs) -> dict:
        ...
        from backend.app.agents.memory_manager import get_memory_manager
...
class GenerationADKAgent(BaseADKAgent):
    ...
    async def _execute(self, input_data: dict, **kwargs) -> dict:
        ...
        from backend.app.agents.full_app_generation import run_full_app_generation
        args = (design_plan, rag_json, event_callback)
        ...
        return await run_full_app_generation(*args)
