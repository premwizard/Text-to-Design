...
from backend.app.services.preview_service import write_files
from backend.project_runner import cleanGeneratedCode

logger = logging.getLogger("backend.app.controllers.generate")
...
async def fix_jsx_stream(broken_code: str, error: str) -> StreamingResponse:
    ...
    from backend.app.utils.jsx_parser import repair_jsx
